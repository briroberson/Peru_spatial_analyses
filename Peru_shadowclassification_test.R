...
L57AL56_greyscale_cropped_sr <- rast(L57aL56_greyscale_cropped) #convert to terra format
...
L57AL56_greyscale_cropped_sr <- project(L57AL56_greyscale_cropped_sr, L57AL56_red)
...
compareGeom(L57AL56_red_ext, L57AL56_green_ext, L57AL56_re_ext, L57AL56_nir_ext, L57AL56_ndvi_ext, L57AL56_msavi_ext, L57AL56_ci_ext, L57AL56_greyscale_cropped_sr)
...
compareGeom(L57AL56_red_ext, L57AL56_green_ext, L57AL56_re_ext, L57AL56_nir_ext, L57AL56_ndvi_ext, L57AL56_msavi_ext, L57AL56_ci_ext, L57AL56_greyscale_cropped_sr, L57AL56_textures_ext)
#should say TRUE


#master stack - trial *removed RGB*
L57AL56_rstack <- c(L57AL56_red_ext, L57AL56_green_ext, L57AL56_re_ext, L57AL56_nir_ext, L57AL56_ndvi_ext, L57AL56_msavi_ext, L57AL56_ci_ext, L57AL56_greyscale_cropped_sr, L57AL56_textures_ext)
names(L57AL56_rstack) <- c("Red", "Green", "RedEdge", "NIR", "NDVI", "MSAVI", "CI", "GREY", names(L57AL56_textures_ext)) 
plot(L57AL56_rstack)
...
set.seed(4)
L57AL56_kmncluster <- kmeans(na.omit(rstack_df_clean), centers = 5, iter.max = 5000)
...
cluster_raster[] <- L57AL56_kmncluster$cluster

k <- length(unique(values(cluster_raster)))
cluster_colors <- c("darkgreen" , "darkolivegreen3" , "burlywood4", "goldenrod3", "bisque1")
plot(cluster_raster, col = cluster_colors)
